...
#include "blob/data/train_iid_cancer_norm_0.csv.h"
#include "blob/data/train_niid_cancer_norm_1.csv.h"
#include "blob/data/val_cancer_norm.csv.h"
#include "blob/data/test_cancer_norm.csv.h"
#include "helper.h"
...
int main()
{ // Load train data
    constexpr size_t cancer_aug_train_csv_size = sizeof(train_niid_cancer_norm_1_csv);

    std::istringstream iss_train(std::string(reinterpret_cast<const char *>(train_niid_cancer_norm_1_csv), cancer_aug_train_csv_size));
    int numFeatures = 30; // Number of features
    int numLabels = 2;    // Number of label classes
    ...
    // Load test data
    constexpr size_t cancer_aug_test_csv_size = sizeof(test_cancer_norm_csv);

    std::istringstream iss_test(std::string(reinterpret_cast<const char *>(test_cancer_norm_csv), cancer_aug_test_csv_size));
    ...
    // Load val data
    constexpr size_t cancer_aug_val_csv_size = sizeof(val_cancer_norm_csv);

    std::istringstream iss_val(std::string(reinterpret_cast<const char *>(val_cancer_norm_csv), cancer_aug_val_csv_size));
