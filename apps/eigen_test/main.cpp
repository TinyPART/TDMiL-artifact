...
public:
    ...
    void train(const MatrixXf &X, const MatrixXf &y, const MatrixXf &X_test, const MatrixXf &y_test, float learningRate, int epochs)
    {
        for (int epoch = 0; epoch < epochs; ++epoch)
        {
            ...
            float accuracy = evaluateAccuracy(X_test, y_test);
